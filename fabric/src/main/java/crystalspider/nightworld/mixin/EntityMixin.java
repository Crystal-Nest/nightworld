  ...
  private TeleportTarget getNightworldTeleportTarget(Entity caller, ServerWorld destination) {
    return this.getPortalRect(destination, getBlockPos(), false, destination.getWorldBorder()).map(rect -> {
      ...
      if (blockState.contains(Properties.HORIZONTAL_AXIS)) {
        ...
        Rectangle rectangle = BlockLocating.getLargestRectangle(this.lastNetherPortalPosition, axis, NetherPortal.MAX_WIDTH, Axis.Y, NetherPortal.MAX_HEIGHT, pos -> world.getBlockState(pos) == blockState);
